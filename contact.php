...
if(isset($_POST['send'])){
   ...
   if(mysqli_num_rows($select_message) > 0){
      $message[] = 'Mesajı gönderdiniz zaten!';
   }else{
...
<section class="contact">
   ...
   <form action="" method="post">
      <h3>Bir şeyler söyle!</h3>
      <input type="text" name="name" required placeholder="İsminizi giriniz" class="box">
      <input type="email" name="email" required placeholder="Emailinizi giriniz" class="box">
